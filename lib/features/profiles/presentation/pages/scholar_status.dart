...
import 'package:study_abroad_cemc_mobile/components/action/stepper.dart';
...
class ScholarStuStatus extends StatefulWidget {
  final String status;
...
class _ScholarStuStatusState extends State<ScholarStuStatus> {
  @override
