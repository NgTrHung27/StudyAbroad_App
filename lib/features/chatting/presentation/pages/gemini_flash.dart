...
class _GeminiAIState extends BasePageState<GeminiAIFlash> {
      ...
      child: Stack(children: [
        DashChat(
          ...
          onSend: (message) {
            ...
            context.read<GeminiChatBloc>().add(SendGeminiMessage(message, modelName: 'gemini-1.5-flash'));
          },
          messages: messages,
  ...
  void _sendMediaMessage() async {
    ...
    if (file != null) {
      ...
      context.read<GeminiChatBloc>().add(SendGeminiMessage(chatMessage, modelName: 'gemini-1.5-flash'));
    }
  }
}
