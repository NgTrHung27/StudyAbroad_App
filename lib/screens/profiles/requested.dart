              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (requirementList != null && requirementList != []) {
                  ...
                  final List<Requirement> pendingRequirements =
                      requirementList.where((requirement) => requirement.status == 'PENDING').toList();
                  return Padding(
                            ...
                            children: [
                              ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final titleRe = pendingRequirements[index].title;
                                  final detailRe = pendingRequirements[index].description;
                                          ...
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) => Respond(
                                                ...
                                                images: pendingRequirements[index].images,
                                              ),
                                            ),
                                          );
                                        },
                                      ),
                                      if (index != pendingRequirements.length - 1)
                                        const Divider(
                                          color: Colors.grey,
                                          thickness: 1.0,
                                          height: 1.0,
