...
class GeminiAIPro extends BasePage {
  const GeminiAIPro({super.key});

  @override
  State<GeminiAIPro> createState() => _GeminiAIState();
}

class _GeminiAIState extends BasePageState<GeminiAIPro> {
